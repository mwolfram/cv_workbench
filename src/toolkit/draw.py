...
class DrawTools():
    ...
    def draw_polygon_with_margin_around_polynomial(out_img, polynomial, margin, color=(0, 255, 255)):
        ...
        ploty = DrawTools.getYValuesForPlotting(out_img)
    ...
    def draw_lane_undistorted(undistd, left_fit, right_fit):
        ...
        lane_color = DrawTools.draw_polygon_between_polynomials(lane_color, left_fit, right_fit)
    ...
    def concatenate_4_images(image1, image2, image3, image4):
        image1 = DrawTools.grayToColor(image1)
        image2 = DrawTools.grayToColor(image2)
        image3 = DrawTools.grayToColor(image3)
        image4 = DrawTools.grayToColor(image4)
